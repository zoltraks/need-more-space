...
SELECT N'.    ┌─────────────────────────────────────┐    .' UNION ALL
SELECT N':    │                                     │    :' UNION ALL 
SELECT N':    │   ENABLE "RESULT TO TEXT" OPTION    │    :' UNION ALL
SELECT N':    │                                     │    :' UNION ALL
SELECT N':    │              (CTRL+T)               │    :' UNION ALL
SELECT N':    │                                     │    :' UNION ALL
SELECT N'`    └─────────────────────────────────────┘    `' UNION ALL
...
WAITFOR DELAY '00:00:03.14' ;

GO

SET NOCOUNT ON ;

DECLARE @N INT ; DECLARE @M INT ; DECLARE @I INT ; DECLARE @K INT ; DECLARE @L NVARCHAR(MAX) ;
SET @N = 0 ; SET @M = 50 ; SET @L = '' ;
...
, ( NULL , '' ) , ( ' ' , N'       ' ) , ( ' ' , N'       ' ) , ( ' ' , N'       ' )
, ( NULL , '' ) , ( 'A' , N'  ┌───┐' ) , ( 'A' , N' ┌────┤' ) , ( 'A' , N'┌┘    │' ) , ( 'A' , N'└┐    │' ) , ( 'A' , N' └────┘' )
, ( NULL , '' ) , ( 'B' , N'┌───┐  ' ) , ( 'B' , N'│   │  ' ) , ( 'B' , N'├───┴─┐' ) , ( 'B' , N'│     │' ) , ( 'B' , N'└─────┘' )
, ( NULL , '' ) , ( 'C' , N' ┌───┐ ' ) , ( 'C' , N'┌┘     ' ) , ( 'C' , N'│      ' ) , ( 'C' , N'└┐     ' ) , ( 'C' , N' └───┘ ' )
, ( NULL , '' ) , ( 'H' , N'┌──   ' ) , ( 'H' , N'│     ' ) , ( 'H' , N'├────┐' ) , ( 'H' , N'│    │' ) , ( 'H' , N'└    ┘' )
, ( NULL , '' ) , ( 'E' , N' ┌───┐ ' ) , ( 'E' , N'┌┘   │ ' ) , ( 'E' , N'├────┘ ' ) , ( 'E' , N'└┐     ' ) , ( 'E' , N' └───┘ ' )
, ( NULL , '' ) , ( 'L' , N' ─┐  ' ) , ( 'L' , N'  │  ' ) , ( 'L' , N'  │  ' ) , ( 'L' , N'  │  ' ) , ( 'L' , N'──┴──' )
, ( NULL , '' ) , ( 'O' , N' ┌───┐ ' ) , ( 'O' , N'┌┘   └┐' ) , ( 'O' , N'│     │' ) , ( 'O' , N'└┐   ┌┘' ) , ( 'O' , N' └───┘ ' )
, ( NULL , '' ) , ( 'V' , N'└┐     ┌┘' ) , ( 'V' , N' └┐   ┌┘' ) , ( 'V' , N'  └┐ ┌┘' ) , ( 'V' , N'   └─┘' )
, ( NULL , '' ) , ( 'R' , N' ┌───┐ ' ) , ( 'R' , N' │     ' ) , ( 'R' , N' │     ' ) , ( 'R' , N' │     ' )
, ( NULL , '' ) , ( 'Y' , N'└┐   ┌┘' ) , ( 'Y' , N' └┐ ┌┘' ) , ( 'Y' , N'  └┬┘' ) , ( 'Y' , N'  ┌┘' ) , ( 'Y' , N' ─┘' )
, ( NULL , '' ) , ( 'D' , N'     │' ) , ( 'D' , N'     │' ) , ( 'D' , N' ┌───┤' ) , ( 'D' , N'┌┘   │' ) , ( 'D' , N'│    │' ) , ( 'D' , N'└┐   │' ) , ( 'D' , N' └───┘' )
, ( NULL , '' ) , ( 'N' , N'┌────┐ ' ) , ( 'N' , N'│    └┐' ) , ( 'N' , N'│     │' ) , ( 'N' , N'│     │ ' )
, ( NULL , '' ) , ( 'W' , N'│      │' ) , ( 'W' , N'│  ┌┐  │' ) , ( 'W' , N'└┐┌┘└┐┌┘' ) , ( 'W' , N' └┘  └┘' )
, ( NULL , '' ) , ( 'M' , N'┌──┬──┐' ) , ( 'M' , N'│  └┐ └┐' ) , ( 'M' , N'│   │  │' ) , ( 'M' , N'│      │ ' )
, ( NULL , '' ) , ( 'T' , N'  │  ' ) , ( 'T' , N'──┼──' ) , ( 'T' , N'  │  ' ) , ( 'T' , N'  │  ' ) , ( 'T' , N'  └─┘' )
, ( NULL , '' ) , ( 'S' , N' ┌───┐ ' ) , ( 'S' , N'┌┘   └┐' ) , ( 'S' , N'└──┐   ' ) , ( 'S' , N'   └──┐' ) , ( 'S' , N'└┐   ┌┘' ) , ( 'S' , N' └───┘ ' )
, ( NULL , '' ) , ( 'Q' , N' ┌───┐' ) , ( 'Q' , N'┌┘   │' ) , ( 'Q' , N'│    │' ) , ( 'Q' , N'└┐   │' ) , ( 'Q' , N' └───┤' ) , ( 'Q' , N'     │' ) , ( 'Q' , N'     │' )
, ( NULL , '' ) , ( 'I' , N' ┌┐  ' ) , ( 'I' , N' └┘  ' ) , ( 'I' , N' ─┐  ' ) , ( 'I' , N'  │  ' ) , ( 'I' , N'  │  ' ) , ( 'I' , N'──┴──' )
, ( NULL , '' ) , ( 'P' , N'┌────┐ ' ) , ( 'P' , N'│    └┐' ) , ( 'P' , N'│     │' ) , ( 'P' , N'│    ┌┘' ) , ( 'P' , N'├────┘ ' ) , ( 'P' , N'│' )
, ( NULL , '' ) , ( 'G' , N' ┌───┐' ) , ( 'G' , N'┌┘   │' ) , ( 'G' , N'│    │' ) , ( 'G' , N'└┐   │' ) , ( 'G' , N' └───┤' ) , ( 'G' , N'     │' ) , ( 'G' , N' └───┘' )
, ( NULL , '' ) , ( 'K' , N'│    ' ) , ( 'K' , N'│   ┌' ) , ( 'K' , N'├──┬┘' ) , ( 'K' , N'│  └┐' ) , ( 'K' , N'    └' )
, ( NULL , '' ) , ( 'Z' , N' ┌───┐' ) , ( 'Z' , N'    ┌┘' ) , ( 'Z' , N'   ┌┘ ' ) , ( 'Z' , N'  ┌┘  ' ) , ( 'Z' , N' ┌┘   ' ) , ( 'Z' , N' └───┘' )
, ( NULL , '' ) , ( 'F' , N'  ┌──' ) , ( 'F' , N'  │  ' ) , ( 'F' , N'──┼──' ) , ( 'F' , N'  │  ' ) , ( 'F' , N'  │  ' ) , ( 'F' , N'  │  ' )
, ( NULL , '' ) , ( 'U' , N'│     │' ) , ( 'U' , N'│     │' ) , ( 'U' , N'└┐   ┌┘' ) , ( 'U' , N' └───┘ ' )
, ( NULL , '' ) , ( '?' , N' ┌──┐ ' ) , ( '?' , N'┌┘  └┐' ) , ( '?' , N'    ┌┘' ) , ( '?' , N'   ┌┘ ' ) , ( '?' , N'   │  ' ) , ( '?' , N'  ┌┐  ' ) , ( '?' , N'  └┘  ' )
;

DECLARE @textLeft NVARCHAR(MAX) ; DECLARE @textLeftLine NVARCHAR(MAX) ;
DECLARE @textLeftCount INT ; DECLARE @textLeftIndex INT ; DECLARE @textLeftCharacter CHAR(1) ; DECLARE @textLeftHeight INT ; DECLARE @textLeftOffset INT ;
...
SET @textLeftCount = LEN(@textLeft) ; SET @textLeftIndex = 1 ; SET @N = 0 ; SET @M = 0 ;

DECLARE @S NVARCHAR(MAX) ; DECLARE @A FLOAT ; DECLARE @B FLOAT ; DECLARE @V FLOAT ; DECLARE @X INT ; DECLARE @Y INT ; 
DECLARE @PAUSE NVARCHAR(MAX) ;

SET @N = 0 ; SET @M = 500 - 15 ;
